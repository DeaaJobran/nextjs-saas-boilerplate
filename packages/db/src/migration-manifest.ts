...
`,
  ...
  {
    id: "0010_emails_notifications_messaging.sql",
    sql: String.raw`CREATE TABLE IF NOT EXISTS notification_preferences (
  id text PRIMARY KEY,
  user_id text NOT NULL REFERENCES auth_users(id) ON DELETE CASCADE,
  tenant_id text REFERENCES organizations(id) ON DELETE CASCADE,
  event_type text NOT NULL,
...
`,
  ...
  {
    id: "0011_observability_monitoring.sql",
    sql: String.raw`CREATE TABLE IF NOT EXISTS observability_logs (
  id text PRIMARY KEY,
  tenant_id text REFERENCES organizations(id) ON DELETE CASCADE,
  actor_id text REFERENCES auth_users(id) ON DELETE SET NULL,
...
`,
  ...
  {
    id: "0012_security_privacy_hardening.sql",
    sql: String.raw`CREATE TABLE IF NOT EXISTS legal_acceptances (
  id text PRIMARY KEY,
  user_id text NOT NULL REFERENCES auth_users(id) ON DELETE CASCADE,
  tenant_id text REFERENCES organizations(id) ON DELETE SET NULL,
...
`,
  ...
  {
    id: "0013_billing_payment_integrity.sql",
    sql: String.raw`ALTER TABLE billing_tenant_settings
...
`,
  ...
  {
    id: "0014_tenant_aware_billing.sql",
    sql: String.raw`ALTER TABLE billing_payment_providers
...
`,
  ...
  {
    id: "0015_optional_tenant_rls.sql",
    sql: String.raw`DO $$
DECLARE
  target record;
BEGIN
