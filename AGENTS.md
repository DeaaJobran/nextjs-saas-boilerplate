...
4. Prefer ready-made shadcn/ui components over hand-rolled primitives when a maintained shadcn/ui component fits the use case. Use lower-level Radix or custom primitives only when shadcn/ui does not provide the needed behavior or the project has an established local abstraction.
