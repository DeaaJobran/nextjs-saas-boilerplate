...
- Partial: foundation exists, but the area is not complete enough to market as production-ready.
...
| Localization and RTL          | P0       | Partial | Localization module owner   | English and Arabic routing, RTL/LTR switching, locale metadata, and formatter helpers exist; broader translation validation and full module coverage remain.              |
